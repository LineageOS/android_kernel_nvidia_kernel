...
tegra194_mc_of_icc_xlate_extended(const struct of_phandle_args *spec, void *data)
{
	...
	list_for_each_entry(node, &mc->provider.nodes, node_list) {
		...
		switch (client->sid) {
		case TEGRA194_SID_NVDISPLAY:
		case TEGRA194_SID_VI:
...
static const struct tegra_mc_icc_ops tegra194_mc_icc_ops = {
	.xlate_extended = tegra194_mc_of_icc_xlate_extended,
